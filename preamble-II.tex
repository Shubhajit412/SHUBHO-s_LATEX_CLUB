...
% or technical requirements. Please note that this is version = v1.1 officially
% released on 29 Mar 2025, written by Shubhajit Dey (shubhajitdey412@icloud.com).
...
%------------------------------------
% to adjust the width of the Abstract section
